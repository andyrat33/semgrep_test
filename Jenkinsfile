pipeline {
  ...
  stages {
    ...
    stage('Dependency-Check') {
      steps {
        dependencyCheck(odcInstallation: '/var/lib/jenkins/tools/org.jenkinsci.plugins.DependencyCheck.tools.DependencyCheckInstallation/dependency-check/dependency-check/')
      }
    }
